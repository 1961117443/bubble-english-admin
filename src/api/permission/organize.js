...
// 删除组织/公司
export const delOrganizeByWay = (id,way) => {
  return request({
    url: `/api/permission/Organize/${way}/${id}`,
    method: 'DELETE'
  })
}
...
// 获取组织/公司下拉框列表集合，非树形
export const getOrganizeSelectorList = (id) => {
  return request({
    url: '/api/permission/Organize/Selector/Company',
    method: 'GET'
  })
}