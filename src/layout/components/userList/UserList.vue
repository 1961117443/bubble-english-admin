<template>
  <div>
    <el-drawer title="内部聊天" :visible.sync="drawer" direction="rtl"
      class="contacts-drawer QT-common-drawer" size="280px" :modal="true" :wrapperClosable="false"
