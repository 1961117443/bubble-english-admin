  ...
  <div class="tableContainer" ref="QTTableInner">
    ...
    <div class="tableContainer-header" v-else>      
      ...
      <div class="tableContainer-header-right">
        <div v-if="hasC" style="padding-right: 10px;">
          <span>当前选中<el-tag>{{ selectedRows.length }}</el-tag>条记录
    ...
    <virtual-scroll
        ...
        :virtualized="true"
    >
      <el-table v-show="!showCheck"  v-if="!refreshTable" :data="tableData" ref="QTTable" class="QT-common-table"
      ...
      >
        <el-table-column prop="selection" type="selection" :width="selectionWidth" v-if="hasC" align="center" />
        ...
        <el-table-column align="center" fixed="right" width="36" v-if="customColumn && !newStyle">
