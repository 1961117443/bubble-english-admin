...
<template>
  <div id="changeContab">
    ...
    <el-tabs v-model="tabsInx" type="border-card">
          ...
          <el-row>
            ...
            >{{ text.Year.specific }}
              <el-checkbox-group
                ...
                @change="v=>checkboxGroupChange(v,'year','3')"
              >
                <el-checkbox
          ...
          <el-row>
            ...
            >{{ text.Month.specific }}
              <el-checkbox-group
                ...
                multiple
                class="checkBox_style"
                @change="v=>checkboxGroupChange(v,'month','3')"
              >
                <el-checkbox
                  v-for="val in 12"
                  :key="val"
      ...
      <!-- 周 -->
      <el-tab-pane name="wek" v-if="false">
      ...
      <el-tab-pane name="day">
        ...
        <div class="tabBody">
          <el-tabs :value="dayTabIndex">
            <el-tab-pane name="day">
              <span slot="label"><i class="el-icon-date" /> 日 </span>
              <el-row>
                <el-radio
                  v-model="day.cronEvery"
                  label="1"
              ...
              <el-row>
                ...
                >{{ text.Day.specificDay }}
                  <el-checkbox-group
                    ...
                    multiple
                    class="checkBox_style"
                  @change="v=>checkboxGroupChange(v,'day','5')"
                  >
                    <el-checkbox
                      v-for="val in 31"
                      :key="val"
              ...
              <el-row>
                ...
                >{{ text.week.specificWeek }}
                  <el-checkbox-group
                    ...
                    multiple
                    class="checkBox_style"
                  @change="v=>checkboxGroupChange(v,'day','4')"
                  >
                    <el-checkbox
                      v-for="val in 7"
          ...
          <el-row>
            ...
            >{{ text.Hours.specific }}
              <el-checkbox-group
                ...
                multiple
                class="checkBox_style"
                @change="v=>checkboxGroupChange(v,'hour','3')"
              >
                <el-checkbox
                  v-for="val in 24"
                  :key="val"
          ...
          <el-row>
            ...
            >{{ text.Minutes.specific }}
              <el-checkbox-group
                ...
                multiple
                class="checkBox_style"
                @change="v=>checkboxGroupChange(v,'minute','3')"
              >
                <el-checkbox
                  v-for="val in 60"
                  :key="val"
          ...
          <el-row>
            ...
            >{{ text.Seconds.specific }}
              <el-checkbox-group
                ...
                class="checkBox_style"
                @change="v=>checkboxGroupChange(v,'second','3')"
              >
                <el-checkbox
                  v-for="val in 60"
                  :key="val"
...
export default {
  ...
  computed: {
    ...
    secondsText() {
      ...
      // console.log('secondsText:',cronEvery)
      switch (cronEvery.toString()) {
        ...
        case '3':
          ...
          console.log(seconds,seconds.slice(0, -1))
    ...
    cron() {
      let str = `${this.secondsText || '*'} ${this.minutesText || '*'} ${this.hoursText || '*'} ${this.daysText || '*'} ${this.monthsText || '*'} ${this.weeksText || '?'}`
      if (!!this.yearsText) {
        return `${str} ${this.yearsText}`
      }
      return str
    ...
    dayTabIndex(){
      ...
      // console.log('dayTabIndex:',cronEvery)
      if (cronEvery && ['2','4','7','8','10','11'].indexOf(cronEvery)>-1) {
        return 'wek'
      }
      return 'day'
    }
  ...
  methods: {
    ...
    commonParser(expressionType, str) {
      if (str == '*') {
        ...
        console.log('commonParser',expressionType, str)
        this.resolveComma(expressionType, str);
      }
    },
    resolveWeek(str) {
      // console.log('resolveWeek:',str)
      if (str.indexOf('/') >= 0) {
        this.day.cronEvery = '2';
        this.resolveSlash(this.week, str);
      } else if (str.indexOf(',') >= 0 || ['SUN','MON','TUE','WED','THU','FRI','SAT'].indexOf(str)> -1) {
    ...
    resolveComma(expressionObj, expression, type = '3') {
      expressionObj.cronEvery = type;
      if (expression) {
        console.log('resolveComma:',expression)
        let aNumb=Array.isArray(expression) ?expression :  expression.split(',')
    ...
    checkboxGroupChange(v,type, value){
      if (v && v.length>0) {
        this[type].cronEvery = value
      }
    }
