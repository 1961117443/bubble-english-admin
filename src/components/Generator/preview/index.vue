<template>
  <el-dialog v-bind="$attrs" :close-on-click-modal="false" fullscreen :modal-append-to-body="false"
    append-to-body v-on="$listeners" @open="onOpen" @close="onClose"
    class="QT-dialog QT-dialog_center" title="预览" :width="formConf.generalWidth">
