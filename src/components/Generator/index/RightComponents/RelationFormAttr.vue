    ...
    getOptions() {
      ...
      const loop = (data, parent) => {
        ...
        if (data.__config__ && data.__config__.qtKey) {
          if (data.__config__.qtKey === 'relationForm' && data.__vModel__) {
            list.push(data)
          }
        }
      }
      ...
      this.options = list.map(o => ({
        ...o,
        prop: o.__config__ && o.__config__.tableName ? o.__vModel__ + '_qtTable_' + o.__config__.tableName + (o.__config__.isSubTable ? '0' : "1") : o.__vModel__
      }))
