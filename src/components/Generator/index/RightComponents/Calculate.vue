<template>
  <el-row>
    ...
    <el-dialog title="编辑计算公式" custom-class="calc-dialog" :visible.sync="expDialogVisible"
      width="600px" class="QT-dialog QT-dialog_center" @open="onOpen" append-to-body>
      <div class="calc-box">
  ...
  computed: {
    calculateCmps() {
      ...
      const loop = (data, parent) => {
        ...
        if (data.__config__ && data.__config__.qtKey && data.__vModel__) {
          if (['numInput', 'calculate'].includes(data.__config__.qtKey)) {
