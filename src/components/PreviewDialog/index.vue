<template>
  <el-dialog :title="title" class="QT-dialog QT-dialog_center previewDialog" lock-scroll
    ...
    <el-dialog :close-on-click-modal="false" :modal-append-to-body="false" append-to-body
      :visible.sync="previewAppVisible" class="QT-dialog QT-dialog_center code-dialog"
