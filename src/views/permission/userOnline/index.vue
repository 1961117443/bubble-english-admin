<template>
  <div class="QT-common-layout QT-flex-main">
    <div class="QT-common-layout-center">
      ...
      <div class="QT-common-layout-main QT-flex-main">
        ...
        <QT-table v-loading="listLoading" :data="tableDataList" has-c
          ...
          <el-table-column label="操作" width="90">
            <template slot-scope="scope">
              <el-button slot="reference" type="text" class="QT-table-delBtn"
