<template>
  <transition name="el-zoom-in-center">
    <div class="QT-preview-main org-form">
      ...
      <div class="main" v-loading="formLoading">
        <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="100px">
          ...
          <el-row :gutter="20" class="custom-row">
            <el-col :sm="12" :xs="24">
              <el-form-item label="上级公司" prop="parentId">
                <QT-TreeSelect v-model="dataForm.parentId" :options="treeData"
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="公司性质" prop="propertyJson.enterpriseNature">
                <QT-TreeSelect v-model="dataForm.propertyJson.enterpriseNature"
                  :options="natureData" placeholder="请选择公司性质" style="width: 100%" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="所属行业" prop="propertyJson.industry">
                <QT-TreeSelect v-model="dataForm.propertyJson.industry" :options="industryData"
          ...
          <el-row :gutter="20" class="custom-row">
            <el-col :sm="12" :xs="24">
              <el-form-item label="启用订单下单" prop="propertyJson.enableOrder" label-width="150px">
                <el-switch v-model="dataForm.propertyJson.enableOrder" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="分拣启用特殊入库" prop="propertyJson.erpEnableCreateTs" label-width="150px">
                <el-switch v-model="dataForm.propertyJson.erpEnableCreateTs" :active-value="1"
                  :inactive-value="0" />
              </el-form-item>
            </el-col>
          </el-row>
