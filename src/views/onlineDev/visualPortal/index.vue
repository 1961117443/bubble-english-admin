<template>
  <div class="QT-common-layout">
    ...
    <el-dialog title="新建门户" :visible.sync="dialogVisible"
      class="QT-dialog QT-dialog-add QT-dialog_center" lock-scroll width="600px">
      <div class="add-main">
        <div class="add-item add-item-sys" @click="addOrUpdateHandle(1)">
          <i class="add-icon icon-qt icon-qt-customUrl"></i>
          <div class="add-txt">
        ...
        <div class="add-item" @click="addOrUpdateHandle(0)">
          <i class="add-icon icon-qt icon-qt-pageDesign"></i>
          <div class="add-txt">
