    ...
    <el-scrollbar class="aside-scrollbar">
      <el-form size="small" label-width="100px" labelPosition="left">
        <template v-if="activeData">
          ...
          <template v-if="activeData.qtKey === 'commonFunc'">
            <el-divider>选项</el-divider>
            <div v-for="(item, index) in activeData.list" :key="index" class="select-item">
              <QT-TreeSelect :options="menuList" v-model="item.id" placeholder="请选择菜单" lastLevel
          ...
          <template v-if="activeData.qtKey === 'dataBoard'">
            <div v-for="(item, index) in activeData.list" :key="index" class="dataBoard-item">
              ...
              <el-form-item label="数据接口" v-if="item.dataType==='dynamic'">
                <QT-TreeSelect :options="dataInterfaceOptions" v-model="item.propsApi"
          ...
          <template v-if="activeData.qtKey && activeData.qtKey.indexOf('Chart')>-1">
            <el-form-item label="数据类型">
            ...
            <el-form-item label="数据接口" v-if="activeData.dataType==='dynamic'">
              <QT-TreeSelect :options="dataInterfaceOptions" v-model="activeData.propsApi"
                placeholder="请选择数据接口" lastLevel lastLevelKey='categoryId' lastLevelValue='1'
                clearable />
            </el-form-item>
          </template>
