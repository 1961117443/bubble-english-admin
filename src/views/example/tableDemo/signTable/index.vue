  ...
  <div class="QT-common-layout">
    <div class="QT-common-layout-center">
      ...
      <div class="QT-common-layout-main  QT-flex-main">
            ...
            <template slot-scope="scope">
              <template v-if="scope.row.signArray.length">
                <span v-for="(item,i) in scope.row.signArray" :key="i">
                  <i class="qt-custom qt-custom-checkbox-blank-circle"
              ...
              <i class="qt-custom qt-custom-checkbox-blank-circle-outline" v-else
        ...
        <QT-Form v-if="formVisible" ref="QTForm" @refreshDataList="initData" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    addOrUpdateHandle(id) {
      ...
      this.$nextTick(() => {
        this.$refs.QTForm.init(this.industryTypeList, id)
      })
    },
