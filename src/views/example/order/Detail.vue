<template>
  <transition name="el-zoom-in-center">
    <div class="QT-preview-main order-form">
      ...
      this.$nextTick(() => {
        if (this.dataForm.id) {
          ...
          Info('crmOrder', this.dataForm.id).then(res => {
            ...
            this.dataForm.orderDate = this.qt.toDate(this.dataForm.orderDate)
            this.dataForm.deliveryDate = this.qt.toDate(this.dataForm.deliveryDate, "yyyy-MM-dd")
