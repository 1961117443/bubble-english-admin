<template>
  <div class="chart-container app-container nohead">
    <el-alert title="免责声明：Highcharts组件不属于本系统产品，只用于介绍第三方组件如何在本系统中使用。如果对这些组件感兴趣，请使用正版。"
      type="warning" :closable="false" class="mb-10" />
    <div style="float: right;padding-right: 10px; margin-top:20px;">
      <el-button type="primary" icon="icon-qt icon-qt-extend-bar-chart" @click="change('plain')">柱状
      </el-button>
      <el-button type="warning" icon="icon-qt icon-qt-extend-mail-forward"
