<template>
  <div class="QT-common-layout menu-list">
    <div class="QT-common-layout-center">
      ...
      <div class="QT-common-layout-main QT-flex-main">
        <el-tabs type="border-card" v-model="listQuery.category" class="menu-tab">
          <el-tab-pane label="后台系统菜单" name="Web"></el-tab-pane>
          <el-tab-pane label="移动端菜单" name="App"></el-tab-pane>
          <div class="box">
            <div class="QT-common-head">
              <topOpts @add="addOrUpdateHandle()" addText="新增目录">
            ...
            <QT-table v-loading="listLoading" :data="treeList" row-key="id" v-if="refreshTable" rowKey="id"
              :default-expand-all="expands" :tree-props="{children: 'children', hasChildren: ''}" :customColumn="false">
              <el-table-column prop="fullName" label="菜单名称" />
              <el-table-column prop="urlAddress" v-if="false" label="菜单地址" show-overflow-tooltip />
              ...
              <el-table-column label="操作" width="150">
                <template slot-scope="scope">
                  <tableOpts @edit="addOrUpdateHandle(scope.row.id)" @del="handleDel(scope.row.id)" :hasDel="scope.row.type === 1">
                    <template v-if="scope.row.type && scope.row.type != 1">
                      <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                          ...
                          <el-dropdown-item @click.native="exportMenu(scope.row.id)" v-if="false">
                            导出模板
                          </el-dropdown-item>
                        </el-dropdown-menu>
                      </el-dropdown>
