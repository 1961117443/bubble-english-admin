...
export default {
  ...
  computed: {
    creatorTime() {
      return this.qt.toDate(this.form.creatorTime)
    },
    entryDate() {
      return this.qt.toDate(this.form.entryDate)
    },
    prevLogTime() {
      return this.qt.toDate(this.form.prevLogTime)
    },
  },
  created() {
    this.getOptions()
