<template>
  <div class="QT-common-layout MessageRecord-container">
      ...
      <div class="QT-common-layout-main QT-flex-main">
        <el-tabs type="border-card" v-model="activeName" class="messageRecord-tab">
          ...
          <div class="box">
            ...
            <QT-table v-loading="listLoading" :data="list" hasC
              ...
              <el-table-column prop="lastModifyTime" label="发送时间" :formatter="qt.tableDateFormat"
                width="120" />
