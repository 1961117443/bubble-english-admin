...
<template>
  <div class="QT-common-layout QT-common-layout-model">
      ...
      <div class="QT-common-layout-main QT-flex-main">
        <div class="QT-common-head">
          ...
          <div class="QT-common-head-right">
            <QuickSearch  ref="Search" :list="columnData.searchList" @reset="reset" @search="search" />
            ...
            <el-tooltip effect="dark" content="显示字段" placement="top">
              ...
              <!-- <el-button icon="icon-qt icon-qt-options QT-common-head-icon" plain  type="success" @click="showCustomColumn" circle></el-button> -->
            </el-tooltip>
            <el-divider direction="vertical"></el-divider>
        ...
        <QT-table ref="tableRef" v-loading="listLoading" :data="list" row-key="id" default-expand-all
          ...
          :custom-column="true" :customSelectedRows="true" hideCC>
          <template #actions>
...
export default {
  name: 'dynamicModel',
  components: { Form, ExportBox, Search, Detail, FlowBox,QuickSearch },
...
.QT-common-layout-model{
  >>> .QT-common-head{
    padding: 5px 10px;
    height: 45px;
  }
  >>> .QT-common-head-right{
