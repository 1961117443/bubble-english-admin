<template>
  <el-dialog :visible.sync="visible" fullscreen lock-scroll class="QT-full-dialog"
    ...
    <div class="QT-common-layout main" v-loading="loading">
      ...
      <div class="QT-common-layout-center">
        <div class="QT-common-layout-main">
          <QTCodeEditor v-model="currentContent" :options="options" ref="CodeEditor" />
        </div>
      </div>
    </div>
  </el-dialog>
...
import QTCodeEditor from '@/components/QTEditor/monaco'
export default {
  components: { QTCodeEditor },
  data() {
    return {
      loading: false,
      visible: false,
