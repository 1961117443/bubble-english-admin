<template>
  <el-dialog :title="webType?'更改模式':'新建'" :close-on-click-modal="false" lock-scroll v-bind="$attrs"
    v-on="$listeners" class="QT-dialog QT-dialog_center" :width="webType?'550px':'800px'">
    <div class="add-main">
      ...
      <div class="add-item add-item-list" @click="add(2)" v-if="webType!==2">
        <i class="add-icon icon-qt icon-qt-sysMenu"></i>
        <div class="add-txt">
      ...
      <div class="add-item" @click="add(3)" v-if="webType!==3">
        <i class="add-icon icon-qt icon-qt-generator-company"></i>
        <div class="add-txt">
