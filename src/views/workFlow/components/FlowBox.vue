<template>
  <transition name="el-zoom-in-center">
    <div class="QT-preview-main flow-form-main">
      ...
      <el-tabs class="QT-el_tabs" v-model="activeTab">
      ...
      <el-dialog :title="eventType==='audit'?'审批通过':'审批拒绝'" :close-on-click-modal="false"
        :visible.sync="visible" class="QT-dialog QT-dialog_center" lock-scroll append-to-body
        width='600px'>
        <el-form label-width="100px" ref="candidateForm" :model="candidateForm">
      ...
      <el-dialog title="指派" :close-on-click-modal="false" :visible.sync="assignVisible"
        ...
        <el-form label-width="100px" :model="assignForm" :rules="assignRules" ref="assignForm">
...
import PrintBrowse from '@/components/PrintBrowse/HiPrintPreview.vue'
