...
let hiPrintPlugin = {
   ...
   * 预览打印，调起系统打印预览
    ...
    * 单模版直接打印， 需客户端支持
	 ...
	 // 一分钟也没连上，自动关闭
	 setTimeout(() => {
		console.log('hiprintPlugin install',window.hiwebSocket)
...
hiprint.version = dependencies['vue-plugin-hiprint']

Object.assign(hiprint,{util})
// hiprint.prototype.util = util;
